...
echo 'iqtree -fast -nt AUTO -st AA -mset Poisson,JTT,JTTDCMut,Dayhoff,DCMut,WAG,mtMAM,mtART,mtREV,rtREV,cpREV,VT,Blosum62,LG,HIVb,HIVw -mrate I+G -redo -s C:\Users\rochmannd\Desktop\coAlignment_PC\'$2'\host_'$i'.fa' >> $2.bat
echo 'iqtree -fast -nt AUTO -st AA -mset Poisson,JTT,JTTDCMut,Dayhoff,DCMut,WAG,mtMAM,mtART,mtREV,rtREV,cpREV,VT,Blosum62,LG,HIVb,HIVw -mrate I+G -redo -s C:\Users\rochmannd\Desktop\coAlignment_PC\'$2'\virus_'$i'.fa' >> $2.bat
